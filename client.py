...
class Client:
    def __init__(self, server_ip="127.0.0.1", server_port=5005, max_segment_size=12):
    ...
    def send_udp(self, message):
        """ Send a message over UDP connection """
...
#      sleep(1) # wait for startup of main thread
    ...
    def receive_acks(self):
        ...
        p = multiprocessing.Process(
            target=self.receive_acks_sub_process, args=(sock, lst_rec_ack_shared))
        p.start()
